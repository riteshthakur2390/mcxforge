...
SUPPORTED_COMMODITIES = ("SILVERM", "GOLDM", "CRUDEOILM", "NATGASM", "NATGASMINI")

# Primary MCX Commodity specifications
COMMODITY_LOT_SIZE    = 5     # 1 lot SILVERM = 5 kg
COMMODITY_STRIKE_STEP = 1000  # 1000 strike step for MCX Silver

# Legacy symbol aliases for compatibility
NIFTY_INDEX_SYMBOL    = os.getenv("INSTRUMENT", "SILVERM")
NIFTY_OPTION_EXCHANGE = "MCX"
NIFTY_LOT_SIZE        = COMMODITY_LOT_SIZE
NIFTY_STRIKE_STEP     = COMMODITY_STRIKE_STEP
