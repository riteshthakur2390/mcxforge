...
# ── RISK MANAGEMENT ──
STOP_LOSS_PCT        = 10
TARGET_PCT           = float(os.getenv("TARGET_PCT", "22.0"))
TRAILING_SL_PCT      = 15
ATR_STOP_MULTIPLIER  = float(os.getenv("ATR_STOP_MULTIPLIER", "1.5"))
ATR_TARGET_MULTIPLIER = float(os.getenv("ATR_TARGET_MULTIPLIER", "2.2"))
MAX_INTRADAY_TARGET_PCT = float(os.getenv("MAX_INTRADAY_TARGET_PCT", "22.0"))
MIN_RR_RATIO = 1.2
...
TOTAL_FUND = float(os.getenv("TOTAL_FUND", "500000"))  # ₹5L default
...
TRAILING_SL_ACTIVATION_PCT = float(os.getenv("TRAILING_SL_ACTIVATION_PCT", "10.0"))
TRAILING_SL_PCT = float(os.getenv("TRAILING_SL_PCT", "8.0"))
TRAILING_SL_PCT_TIER2 = float(os.getenv("TRAILING_SL_PCT_TIER2", "10.0"))
TRAILING_SL_PCT_TIER3 = float(os.getenv("TRAILING_SL_PCT_TIER3", "12.0"))
...
TOTAL_FUND = float(os.getenv("TOTAL_FUND", "500000"))
DEPLOYED_CAPITAL = float(os.getenv("DEPLOYED_CAPITAL", "100000"))
