...
# ── ML FILTER ──
ML_MIN_CONFIDENCE    = float(os.getenv("ML_MIN_CONFIDENCE", "0.28"))   # 0.28 empirical alpha gate
ML_MIN_MODEL_CONFIDENCE = float(os.getenv("ML_MIN_MODEL_CONFIDENCE", "0.28"))
ML_TREND_PULLBACK_MIN_CONFIDENCE = float(os.getenv("ML_TREND_PULLBACK_MIN_CONFIDENCE", "0.28"))
ML_BREAKOUT_MIN_CONFIDENCE = float(os.getenv("ML_BREAKOUT_MIN_CONFIDENCE", "0.28"))
ML_THRESHOLD_OVERRIDE = float(os.getenv("ML_THRESHOLD_OVERRIDE", "0.28"))
