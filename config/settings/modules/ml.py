...
# ── ML FILTER ──
ML_MIN_CONFIDENCE    = float(os.getenv("ML_MIN_CONFIDENCE", "0.32"))   # 0.32 empirical alpha gate
ML_MIN_MODEL_CONFIDENCE = float(os.getenv("ML_MIN_MODEL_CONFIDENCE", "0.32"))
ML_TREND_PULLBACK_MIN_CONFIDENCE = float(os.getenv("ML_TREND_PULLBACK_MIN_CONFIDENCE", "0.32"))
ML_BREAKOUT_MIN_CONFIDENCE = float(os.getenv("ML_BREAKOUT_MIN_CONFIDENCE", "0.32"))
ML_THRESHOLD_OVERRIDE = float(os.getenv("ML_THRESHOLD_OVERRIDE", "0.32"))
